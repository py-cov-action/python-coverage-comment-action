...
def test_template__coverage_unchanged(coverage_obj, diff_coverage_obj):
    result = template.get_comment_markdown(
        coverage=coverage_obj,
        diff_coverage=diff_coverage_obj,
        previous_coverage=None,
        previous_coverage_rate=coverage_obj.info.percent_covered,
    ...
    assert (
        "https://img.shields.io/badge/Coverage%20evolution-62%25%20%E2%86%92%2062%25-blue.svg"
        in result
    )
